...
/**
 * Administration → Citizen detail.
 * Shows the citizen's profile and their system-trail activity (filterable by
 ...
 * }} props
 */
export default async function CitizenDetailPage({ params, searchParams }) {
  ...
  const backHref = `/${lang}/administration/citizens`;
  ...
  return (
    ...
    >
      <UserActivityPanel
        userId={userId}
        basePath={`/administration/citizens/${id}`}
        sp={sp}

...
/**
 * Applies the shared extensibility contract ({@link ExtensionPointRules}) to the engagement
 * vertical. The rules live in {@code model-city-commons}; this test only scopes them to
 * {@code com.modelcity.engagement}, so a future vertical is covered by copying this ~6-line class.
 */
class EngagementExtensibilityArchTest {

    private static final JavaClasses CLASSES =
            ExtensionPointRules.importVertical("com.modelcity.engagement");

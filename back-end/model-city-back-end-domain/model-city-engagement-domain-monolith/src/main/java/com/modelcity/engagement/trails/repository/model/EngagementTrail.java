...
/**
 * Monolith flavour of the engagement audit-log entry: adds real read-only {@code @ManyToOne}
 * navigations to {@link User}, {@link Neighbourhood} and {@link Zone} on top of the invariant mapping in
 * {@link EngagementTrailBase}.
 */
@Entity
